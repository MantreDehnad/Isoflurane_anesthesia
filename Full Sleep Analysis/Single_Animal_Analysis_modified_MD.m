...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fn,p] = uigetfile([pwd filesep '*.xls'],'Choose TM file:');
if fn==0
    return;
end
...
[f1,p1] = uigetfile([pwd filesep '*.xls'],...
...
[fn{i},p{i}] = uigetfile([p{1} '*.xls'],'Choose File:');
if p{i}==0,
    return;
end
setappdata(handles.output,'Files',fn);
...
[fn,p] = uiputfile([pwd filesep '*.xls'],'Choose Output file');
h = handles.output;
